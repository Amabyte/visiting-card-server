class VisitingCard < ActiveRecord::Base
  ...
  has_attached_file :image, :styles => { :medium => "300x300>", :thumb => "100x100>" }, :path => ":rails_root/data/images/vc/:id/:style/:attachment.:extension",:url => "/:style/:attachment.:extension"
